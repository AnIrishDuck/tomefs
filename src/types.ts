...
/** log2(PAGE_SIZE) — for replacing division with right-shift on hot paths. */
export const PAGE_SHIFT = 13;

/** PAGE_SIZE - 1 — bitmask for replacing modulo with bitwise AND on hot paths. */
export const PAGE_MASK = 0x1fff;
