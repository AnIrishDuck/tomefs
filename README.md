...
**Core complete.** The filesystem, page cache, IDB backend, SAB bridge, and full-stack integration are tested and working (4700+ tests). See [plans/](plans/) for architecture and design rationale.
