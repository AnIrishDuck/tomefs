...
> **Disclaimer:** This codebase has been entirely generated by AI agents. The only material that has been thoroughly reviewed by a human is [plans/ethos.md](plans/ethos.md).
...
**Core complete.** The filesystem, page cache, IDB backend, SAB bridge, and full-stack integration are tested and working (4700+ tests). See [plans/ethos.md](plans/ethos.md) for design rationale.
